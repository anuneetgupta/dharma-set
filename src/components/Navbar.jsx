      ...
      >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-[auto_1fr_auto] items-center h-16 gap-4">
                  ...
                  <AnimatePresence>
                    {userMenuOpen && (
                      <motion.div
                        ...
                        className="absolute right-0 top-full mt-2 w-48 bg-cosmic-800/98 backdrop-blur-xl border border-white/[0.10] rounded-xl shadow-card overflow-hidden z-50"
                      >
            ...
            <button
              className="lg:hidden p-2 rounded-lg text-white/60 hover:text-gold-400 hover:bg-white/5 transition-all col-start-3 justify-self-end"
      ...
      <AnimatePresence>
        {mobileOpen && (
          <motion.div
            ...
            className="lg:hidden w-full bg-cosmic-800/98 backdrop-blur-xl border-b border-gold-500/20 shadow-card z-40"
          >
            {/* Scrollable area caps height on short landscape screens */}
