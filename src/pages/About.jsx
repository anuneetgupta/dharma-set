...
function AnimatedStat({ value, label }) {
  ...
  return (
    ...
    >
      <div className="font-serif text-3xl sm:text-4xl text-gold-400 mb-1">
      ...
      <section className="relative py-24 sm:py-32 overflow-hidden">
        ...
        <div className="relative z-10 page-container text-center">
          <motion.div initial={{ scale: 0.5, opacity: 0 }} animate={{ scale: 1, opacity: 1 }} transition={{ duration: 0.8 }} className="mb-6">
            <div className="inline-flex items-center justify-center w-16 h-16 rounded-full bg-gradient-to-br from-gold-600/20 to-gold-400/10 border border-gold-500/30 shadow-gold om-glow glyph-draw">
      ...
      <section className="py-20">
        <div className="page-container">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
            {aims.map((aim, i) => (
              <motion.div key={aim.title} custom={i} variants={cardVariants} initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-50px" }} className={`glass-card border ${aim.border} p-7 hover:shadow-card transition-all duration-300`}>
        ...
        <div className="page-container">
          <motion.div variants={fade} initial="hidden" whileInView="visible" viewport={{ once: true }} className="relative overflow-hidden glass-card-gold text-center py-14 px-6 rounded-3xl">
            ...
            <div className="relative z-10">
              <div className="font-serif text-5xl text-gold-400 mb-4 om-glow glyph-draw">ॐ</div>
